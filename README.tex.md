...
For the purpose of more robust computation, we use $N=\tau/dt$
points to represent the function. Since *dt* is usually set 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2MDQ2MjQ0MCwtMTQwNTA4MzcxMSwtMT
