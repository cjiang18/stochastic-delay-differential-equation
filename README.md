...
A pullback means we have  t taking negative es. For example, if pullback is 200, then the system starts at t = -200.  We want to make sure that the noise realisation should be the same at each time point, so we can adjust the value of pullback and explore pullback attractors.  
...
This makes sure that once the random seed is fixed, we adjust pullback and the final time as we wish without altering the noise.
...
We use finite points to represent <img src="/tex/88f71b85e085edde86f85589ffc56808Although the delay funcequation <img src="/tex/057fde3677e10e4628746048e05a0584.svg?invert_in_darkmode&sanitize=true" align=middle width=9111.675088992643029999998pt height=24.65753399999998pt/>. is infinite dimensional, we estimate lyapunov spectrum using finite points to approximate. 
...
points, which are evenly spaced in the time domain, to represent the function, where <img src="/tex/5a8af6f173febd968ef4c52695efcf85.svg?invert_in_darkmode&sanitize=true" align=middle width=14.492060549999989pt height=22.831056599999986pt/> is set to guarantee that <img src="/tex/c7f4bd27295dced6069c17f5d8b3a740.svg?invert_in_darkmode&sanitize=true" align=middle width=73.79497124999999pt height=22.465723500000017pt/> is an integer. Now the delayinfinite dimensional functions is approximated by a <img src="/tex/c7f4bd27295dced6069c17f5d8b3a740.svg?invert_in_darkmode&sanitize=true" align=middle width=73.79497124999999pt height=22.465723500000017pt/>-dimensional object.  Thus, this <img src="/tex/c7f4bd27295dced6069c17f5d8b3a740.svg?invert_in_darkmode&sanitize=true" align=middle width=73.79497124999999pt height=22.465723500000017pt/>-dimensional object can be represented by a <img src="/tex/c7f4bd27295dced6069c17f5d8b3a740.svg?invert_in_darkmode&sanitize=true" align=middle width=73.79497124999999pt height=22.465723500000017pt/>-dimensional vector, indicating the values the object takes at each time point. (i.e. when <img src="/tex/4db09eca404b6373aa70dcf52c5d5a02.svg?invert_in_darkmode&sanitize=true" align=middle width=92.67200744999998pt height=22.831056599999986pt/>, where <img src="/tex/77a3b857d53fb44e33b53e4c8b68351ab8e71c04cd07c30496b114def8f62906.svg?invert_in_darkmode&sanitize=true" align=middle width=5.663225636.900580199999989pt height=21.68300969999999pt/> is an integer and <img src="/tex/fdbbfa1953de6dd25571246914e16198.svg?invert_in_darkmode&sanitize=true" align=middle width=159.82305075pt height=22.4657235000000170.221802699999984pt/>   ) 
...
<img src="/tex/1e1fb597f72d84098daaff10e936cf68f3d59e27bbdde3d8f274711476b26817.svg?invert_in_darkmode&sanitize=true" align=middle width=268.83810525145.51802924999998pt height=24.65753399999998pt/>

<img src="/tex/361ec937520e1899ad9df6225b2910c300a961082d0e3a812bda642b35d9aaf0.svg?invert_in_darkmode&sanitize=true" align=middle width=278.796417926.49434829999996pt height=24.65753399999998pt/>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwMDkwNTUxLC04NjQ0MTczMTUsLTIyMD
MyMTU1MywxMzk5MzMzMDA4LC04NDA1NTY5NTksMTY0NjQ0MDE0
MywxNDEzODQ2MTAsLTE1Mzc2MjcyOSw4NDg5NTQwNDgsMTE3Mz
